...
export default async function handler(req, res) {
  ...
  try {
    ...
    const safeCandidates = (candidates || []).slice(0, 35).map(c => ({
      name: c.name,
      region: c.region,
      country: c.country,
      domestic: c.domestic,
